...
• How discounts influence order quantities  
• Which product categories perform best  
• Where delivery performance issues exist  

The project demonstrates the full analytics workflow from **data preparation to business insights.**
...
The dataset was cleaned, transformed, and modelled in Power BI before analysis.
...
• Removed duplicate records and validated data consistency  
...
• Some regions generated **around 18% lower revenue than average**, highlighting opportunities for targeted sales strategies.  
• Customer acquisition declined after mid-2023, suggesting a need for improved marketing or retention strategies.
...
• Investigate logistics bottlenecks in regions with high late-delivery rates.  
• Optimise discount strategies to maximise revenue while maintaining profitability.  
• Focus marketing campaigns on regions with lower sales performance.  
...
3. Use the filters and slicers to explore different insights interactively
